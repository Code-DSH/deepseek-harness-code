...
- Unit/state/security and conversation behavior: 27 files, 102 tests covering the desktop host, watchdog, progressive preset installer, stream-output model/controller, ThinkingOrb lifecycle, and the installed rc.6 conversation bundle.
