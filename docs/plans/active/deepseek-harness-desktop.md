...
- 2026-08-20 — Consolidated all branch/worktree differences on `main`, restored the exact rc.8 macOS sidebar safe-area patch, made package tests regenerate ignored installer assets, migrated nested agent-named resources to the docs/resource layer, and verified build + 303 unit + 108 Anchored + 24 plugin + 33 package + 2 Playwright tests, `check`, and the 51-artifact runtime closure.
