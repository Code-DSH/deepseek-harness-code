...
| 产物 | SHA-256 |
| --- | --- |
| DeepSeek-Harness-Code-0.1.0-BETA1-mac-universal.dmg | 发布后回填 |
...
欢迎通过 [GitHub Issues](https://github.com/Code-DSH/deepseek-harness-code/issues) 反馈问题与建议。发布说明同时收录于仓库 `docs/releases/v0.1.0-BETA1.md`。
