...
- **系统 Node 模型**：移除便携 Node 下载；运行时完全依赖系统官方 Node.js（>=22.13，自动探测 nodejs.org/Homebrew/nvm/Volta/fnm/mise/Scoop/Chocolatey + NVM_DIR/VOLTA_HOME/FNM_DIR），未检测到可用 Node 时显示安装引导对话框。
