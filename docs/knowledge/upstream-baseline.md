...
| 2026-08-16   | Installed rc.8 CLI, `@deepseek-ai/dsh-home-paths`, and real Electron integration test                                           | `dsh`/Home paths `0.1.0-rc.8`, pnpm `11.19.0`                                | Resolver precedence, public plugin reconciliation, bundled pnpm launcher, and bare-name boot graph | high       |
