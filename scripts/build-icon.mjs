...
try {
  ...
  await writeFile(
    ...
    [
      ...
      "",
      "- DeepSeek Harness and the black graphic used in the DeepSeek Harness Code icon are distributed under the upstream MIT license. The maintained runtime family is `0.1.1-rc.2.code.1`, based on upstream `0.1.1-rc.2`.",
