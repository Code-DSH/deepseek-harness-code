...
- The bundled conversation status indicator uses `thinking-orbs 0.3.1` under the MIT license. Full copyright and license text ships at `desktop-plugin/THIRD_PARTY_NOTICES.md`.
