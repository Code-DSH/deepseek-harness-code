...
- **Safe experimental integration** — Anchored Standard is a separate official-format bundle and fails closed to Standard on the pinned Harness rc.7 API.
...
| Harness runtime  | Pinned `@deepseek-ai/dsh` rc.7, loopback-only Web service, official single Harness Home               |
