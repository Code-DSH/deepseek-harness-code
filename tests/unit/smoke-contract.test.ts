...
describe("application-owned smoke contract", () => {
  ...
  it.each([
    ...
    [
      "win32",
      "arm64",
      "https://nodejs.org/dist/v22.19.0/node-v22.19.0-arm64.msi",
      "https://nodejs.org/dist/v22.19.0/node-v22.19.0-win-arm64.zip",
    ],
    [
      "darwin",
      "arm64",
      "https://nodejs.org/dist/v22.19.0/node-v22.19.0.pkg",
    ...
    [
      ...
      "x64",
      "https://nodejs.org/dist/v22.19.0/node-v22.19.0.pkg",
      "https://nodejs.org/dist/v22.19.0/node-v22.19.0-darwin-x64.tar.gz",
    ],
    [
      "linux",
      "x64",
