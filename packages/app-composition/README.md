...
- `mcp-context7` — dormant `@deepseek-ai/dsh-mcp-client` bridge to Context7
  (streamable-http). A user profile may enable it explicitly; desktop startup
  never waits for a remote MCP endpoint.
